 ...
 * @return:
 */
std::vector<ImageElement> scandir(std::string path) {
...
/*! Walk through directory structure and scan for image elements.
 *
 * @param path: Directory path to scan.
 * @return:
 */
std::vector<ImageElement> walk(std::string path) {
