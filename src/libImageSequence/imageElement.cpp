 ...
 *
 */
ImageElement::ImageElement(const ImageElement &obj, std::string) {
    this->name = obj.name;
    this->extension = obj.extension;
    this->filePath = obj.filePath;
    this->framePadding = obj.framePadding;
    this->upToDate = obj.upToDate;
 ...
 */
void ImageElement::parseName(std::string filename) {
    smatch match_result;
 ...
 */
std::string ImageElement::evalAtFrame(int frame) {
 ...
 */
bool ImageElement::validateFile(std::string path) {
